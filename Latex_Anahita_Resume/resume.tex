...
%%% Essentials
\name{Anahita}{Kaul}
\address{3-67, 3/96, Netaji Nagar, Gulmohar Park Colony, Serilingampally, Hyderabad-500019}
\mobile{(+91) 9713795502}
%%% Social
\email{anahitakaul@gmail.com}
\linkedin{anahita-kaul-171196a1}
%%% Optionals
\position{Deputy Manager II{\enskip\cdotp\enskip}ICICI BANK}
